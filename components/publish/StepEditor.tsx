            ...
            >
              ...
              <div className="flex-1 relative">
                  ...
                  <textarea
                    ...
                    className="w-full min-h-[140px] p-6 bg-zinc-900/20 border border-white/5 rounded-4xl text-zinc-200 placeholder:text-zinc-800 focus:outline-none focus:ring-2 focus:ring-orange-500/20 focus:border-orange-500/40 transition-all font-medium leading-relaxed backdrop-blur-md resize-none shadow-lg"
                  />
                  <Button 
                    variant="ghost" 
                    size="icon" 
